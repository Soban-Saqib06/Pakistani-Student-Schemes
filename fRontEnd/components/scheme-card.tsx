      ...
      <div className="glass-card-container group/scheme flex w-full min-w-0 max-w-full">
        <div className="glass-box relative z-10 flex w-full min-w-0 max-w-full flex-col justify-between gap-4 overflow-hidden rounded-2xl p-4 sm:p-5 md:flex-row md:items-center">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-1.5 text-xs sm:text-sm font-normal leading-relaxed text-[#d0ddd3] line-clamp-2 max-w-3xl">
              {scheme.description}
            </p>
          ...
          <div className="flex items-center justify-between gap-3 pt-3 border-t border-[#3c6258]/35 md:pt-0 md:border-t-0 md:flex-col md:items-end md:justify-center shrink-0">
            ...
            <div className="flex items-center gap-2 relative z-20">
              ...
              <Link
                href={`/schemes/${scheme.id}`}
                className="inline-flex items-center gap-1.5 rounded-md bg-[#3c6258] hover:bg-[#48776b] px-3.5 py-2 text-xs font-bold text-white shadow-xs transition-colors cursor-pointer"
              >
      ...
      <div className="md:hidden glass-card-container group/scheme flex w-full min-w-0 max-w-full">
        <div className="glass-box relative z-10 flex w-full min-w-0 max-w-full flex-col justify-between gap-3.5 overflow-hidden rounded-2xl p-4">
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-1.5 text-xs font-normal leading-relaxed text-[#d0ddd3] line-clamp-2">
              {scheme.description}
            </p>
          ...
          <div className="flex items-center justify-between gap-2 pt-3 border-t border-[#3c6258]/35">
            ...
            <div className="flex items-center gap-2 relative z-20">
              ...
              <Link
                href={`/schemes/${scheme.id}`}
                className="inline-flex items-center gap-1 rounded-md bg-[#3c6258] hover:bg-[#48776b] px-3 py-1.5 text-xs font-bold text-white shadow-xs transition-colors cursor-pointer"
              >
                <span>Details</span>
      ...
      <div className="hidden md:flex glass-card-container group/scheme w-full min-w-0 max-w-full">
        <div className="glass-box relative z-10 flex w-full min-w-0 max-w-full flex-col justify-between overflow-hidden rounded-2xl p-5">
          ...
          <div className="min-w-0">
            ...
            {/* Description */}
            <p className="mt-2.5 text-sm font-normal leading-relaxed text-[#d0ddd3] line-clamp-3">
              {scheme.description}
            </p>
          </div>
