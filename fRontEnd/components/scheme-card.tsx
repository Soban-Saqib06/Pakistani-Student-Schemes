      ...
      <div className="glass-card-container group/scheme flex w-full min-w-0 max-w-full">
        <div className="glass-box relative z-10 flex w-full min-w-0 max-w-full flex-col justify-between gap-4 overflow-hidden rounded-2xl p-4 sm:p-5 md:flex-row md:items-center">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-1.5 text-xs sm:text-sm font-normal leading-relaxed text-neutral-200 line-clamp-2 max-w-3xl">
              {scheme.description}
            </p>

            <div className="mt-3 flex flex-wrap items-center gap-x-5 gap-y-1.5 text-xs sm:text-sm text-neutral-300">
          ...
          <div className="flex items-center justify-between gap-3 pt-3 border-t border-white/10 md:pt-0 md:border-t-0 md:flex-col md:items-end md:justify-center shrink-0">
            <div className="rounded-xl bg-white/5 px-3 py-1.5 text-xs sm:text-sm text-neutral-200 border border-white/10 backdrop-blur-xs max-w-xs truncate">
    ...
    <>
      ...
      <div className="md:hidden glass-card-container group/scheme flex w-full min-w-0 max-w-full">
        <div className="glass-box relative z-10 flex w-full min-w-0 max-w-full flex-col justify-between gap-3.5 overflow-hidden rounded-2xl p-4">
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-1.5 text-xs font-normal leading-relaxed text-neutral-200 line-clamp-2">
              {scheme.description}
            </p>

            <div className="mt-2.5 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-neutral-300">
              <span className="flex items-center gap-1.5 min-w-0">
          ...
          <div className="flex items-center justify-between gap-2 pt-3 border-t border-white/10">
            <div className="rounded-lg bg-white/5 px-2.5 py-1 text-xs text-neutral-200 border border-white/10 backdrop-blur-xs max-w-[55%] truncate">
              <strong className="font-semibold text-white">Benefit: </strong>
              <span className="text-neutral-200">{scheme.benefits}</span>
            </div>
            ...
            <div className="flex items-center gap-2 relative z-20">
              ...
              <Link
                href={`/schemes/${scheme.id}`}
                className="inline-flex items-center gap-1 rounded-md bg-pak-green px-3 py-1.5 text-xs font-semibold text-white shadow-xs transition-colors hover:bg-pak-green/90 cursor-pointer"
              >
                <span>Details</span>
      ...
      <div className="hidden md:flex glass-card-container group/scheme w-full min-w-0 max-w-full">
        <div className="glass-box relative z-10 flex w-full min-w-0 max-w-full flex-col justify-between overflow-hidden rounded-2xl p-5">
          ...
          {/* Bottom Details & Meta */}
          <div className="mt-5 pt-3.5 border-t border-white/10 min-w-0">
            ...
            <div className="mt-3.5 flex items-center justify-between rounded-xl bg-white/5 px-3.5 py-2.5 text-sm text-neutral-200 border border-white/10 backdrop-blur-xs min-w-0">
